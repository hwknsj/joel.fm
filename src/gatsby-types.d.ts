...
type FileFieldsEnum =
  ...
  | 'childMarkdownRemark.fields.url'
  ...
  | 'childrenMarkdownRemark.fields.url'
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.favicon.ico'
  | 'siteMetadata.favicon.png'
  | 'siteMetadata.favicon.svg'
...
type Unnamed_1_Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } }> } };
